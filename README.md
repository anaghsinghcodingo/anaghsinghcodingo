# Hi, I'm Anagh Singh 👋
<img align="right" src="https://github.com/anaghsinghcodingo.png" alt="Anagh Singh" width="120" style="border-radius:50%; border:3px solid #fff; box-shadow:0 4px 14px rgba(0,0,0,0.15)"/>

<!-- Animated header (SVG) -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 140" preserveAspectRatio="none" width="100%" height="140" role="img" aria-label="Animated header">
  <defs>
    <linearGradient id="g" x1="0%" x2="100%" y1="0%" y2="0%">
      <stop offset="0%" stop-color="#7b2ff7">
        <animate attributeName="stop-color" dur="8s" repeatCount="indefinite" values="#7b2ff7;#ff6a88;#ffd86b;#7b2ff7"/>
      </stop>
      <stop offset="100%" stop-color="#ffd86b">
        <animate attributeName="stop-color" dur="8s" repeatCount="indefinite" values="#ffd86b;#7b2ff7;#ff6a88;#ffd86b"/>
      </stop>
    </linearGradient>
  </defs>
...
[![Open to Work](https://img.shields.io/badge/OPEN%20TO%20WORK-Yes-2bbc8a?logo=briefcase)](mailto:anaghsingh2013@gmail.com)
[![Website](https://img.shields.io/badge/website-Quantara%20Nexus-blue?logo=netlify)](https://quantaranexus.pages.dev/)
[![Discord](https://img.shields.io/badge/Discord-1436997265343385733-7289da?logo=discord)](https://discord.com/users/1436997265343385733)
...
### Mystic Haven — mystichaven.pages.dev
A responsive, modern landing site I built for Mystic Haven.
- Live: https://mystichaven.pages.dev/
- Repo: https://github.com/anaghsinghcodingo/mystic-haven-web

### Quantara Nexus — quantaranexus.pages.dev
The Quantara Nexus website I built — showcasing our work and platform.
